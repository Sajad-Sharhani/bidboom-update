...
> = {
  ...
  >;
  media?: Resolver<
    Maybe<Array<Maybe<ResolversTypes["Files_challenge"]>>>,
    ParentType,
    ContextType
  >;
...
export type File_ChallengeResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["File_challenge"] = ResolversParentTypes["File_challenge"]
> = {
...
export type Files_ChallengeResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["Files_challenge"] = ResolversParentTypes["Files_challenge"]
> = {
  files?: Resolver<
    Array<Maybe<ResolversTypes["File_challenge"]>>,
    ParentType,
    ContextType
  >;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
> = {
  ...
  >;
  disableChallenge?: Resolver<
    ResolversTypes["GetChallengeType"],
    ParentType,
    ContextType,
    RequireFields<MutationDisableChallengeArgs, "input">
  >;
  deleteChallenge?: Resolver<
    ResolversTypes["GetChallengeType"],
    ParentType,
    ContextType,
    RequireFields<MutationDeleteChallengeArgs, "input">
  >;
  sendAnswer?: Resolver<
...
> = {
  getChallenge?: Resolver<
    ...
    ContextType
  >;
  getChallengesSuperAdmin?: Resolver<
    Array<Maybe<ResolversTypes["GetChallengeType"]>>,
    ParentType,
    ContextType
  >;
  getChallengersSuperAdmin?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryGetChallengersSuperAdminArgs, "input">
  >;
};
