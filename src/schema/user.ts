...
export type ResolversTypes = {
  ...
  User: never;
  UserType: UserType;
  User_type: ResolverTypeWrapper<User_Type>;
};
...
export type CreateGoogleUserResponseResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["CreateGoogleUserResponse"] = ResolversParentTypes["CreateGoogleUserResponse"]
> = {
...
export type EntriesResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["Entries"] = ResolversParentTypes["Entries"]
> = {
...
export type GetUserInfoResponseResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["GetUserInfoResponse"] = ResolversParentTypes["GetUserInfoResponse"]
> = {
  _id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
...
export type GoogleRedirectResponseResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["GoogleRedirectResponse"] = ResolversParentTypes["GoogleRedirectResponse"]
> = {
...
> = {
  ...
  createGoogleUser?: Resolver<
    ResolversTypes["CreateGoogleUserResponse"],
    ParentType,
    ContextType,
  ...
  mutateUser?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationMutateUserArgs, never>
  >;
  mutateAmbassador?: Resolver<
    ResolversTypes["Response"],
    ParentType,
    ContextType,
    RequireFields<MutationMutateAmbassadorArgs, never>
  >;
  sendNotification?: Resolver<
    ResolversTypes["NotificationResponse"],
    ParentType,
    ContextType,
    RequireFields<MutationSendNotificationArgs, never>
  >;
  resetIdentifierCode?: Resolver<
    ResolversTypes["ResetIdentifierCodeResponse"],
    ParentType,
    ContextType
  >;
};
...
> = {
  getGoogleRedirect?: Resolver<
    ResolversTypes["GoogleRedirectResponse"],
    ParentType,
    ContextType,
    RequireFields<QueryGetGoogleRedirectArgs, never>
  >;
  getUserInfo?: Resolver<
    ResolversTypes["GetUserInfoResponse"],
    ParentType,
    ContextType,
    RequireFields<QueryGetUserInfoArgs, "input">
  >;
  getNotifications?: Resolver<
    Array<Maybe<ResolversTypes["Notification"]>>,
    ParentType,
    ContextType,
    RequireFields<QueryGetNotificationsArgs, never>
  >;
  getPopularAmbassadors?: Resolver<
    Array<Maybe<ResolversTypes["User_type"]>>,
    ParentType,
    ContextType
  >;
  getArchives?: Resolver<
...
export type ResetIdentifierCodeResponseResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["ResetIdentifierCodeResponse"] = ResolversParentTypes["ResetIdentifierCodeResponse"]
> = {
  identifierCode?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
...
export type SmsResponseResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["SmsResponse"] = ResolversParentTypes["SmsResponse"]
> = {
...
> = {
  ...
  >;
  type?: Resolver<ResolversTypes["UserType"], ParentType, ContextType>;
  registerations?: Resolver<
    Maybe<ResolversTypes["Registerations"]>,
    ParentType,
    ContextType
  >;
  archives?: Resolver<
...
export type User_TypeResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["User_type"] = ResolversParentTypes["User_type"]
> = {
  _id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
  name?: Resolver<Maybe<ResolversTypes["String"]>, ParentType, ContextType>;
  email?: Resolver<Maybe<ResolversTypes["String"]>, ParentType, ContextType>;
...
export type Resolvers<ContextType = any> = {
  ...
  User_type?: User_TypeResolvers<ContextType>;
};
