...
export type CommentPathResponseResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["CommentPathResponse"] = ResolversParentTypes["CommentPathResponse"]
> = {
...
> = {
  ...
  likePath?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationLikePathArgs, "input">
  >;
  dislikePath?: Resolver<
    ResolversTypes["PathType"],
    ParentType,
    ContextType,
    RequireFields<MutationDislikePathArgs, "input">
  >;
  commentPath?: Resolver<
    ResolversTypes["CommentPathResponse"],
    ParentType,
    ContextType,
    RequireFields<MutationCommentPathArgs, "input">
  >;
  removeCommentPath?: Resolver<
    ResolversTypes["PathType"],
    ParentType,
    ContextType,
    RequireFields<MutationRemoveCommentPathArgs, "input">
  >;
  archivePath?: Resolver<
    ResolversTypes["PathType"],
    ParentType,
    ContextType,
    RequireFields<MutationArchivePathArgs, "input">
  >;
  restorePath?: Resolver<
    ResolversTypes["PathType"],
    ParentType,
    ContextType,
    RequireFields<MutationRestorePathArgs, "input">
  >;
};
...
> = {
  ...
  originPoint?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
  destinationPoint?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
    ContextType
  >;
  ...
  suitableCar?: Resolver<
    Maybe<Array<ResolversTypes["SuitableCar"]>>,
    ParentType,
    ContextType
  >;
  ...
  suitablePeople?: Resolver<
    Maybe<Array<ResolversTypes["SuitablePeople"]>>,
    ParentType,
    ContextType
  >;
  facilities?: Resolver<
    Maybe<Array<ResolversTypes["Facilities"]>>,
    ParentType,
    ContextType
  >;
...
> = {
  ...
  >;
  getCity?: Resolver<
    Array<ResolversTypes["Locality"]>,
    ParentType,
    ContextType
  >;
  getProvince?: Resolver<
    Array<ResolversTypes["Locality"]>,
    ParentType,
    ContextType
  >;
  getCountry?: Resolver<
    ...
    ContextType
  >;
  getPopularPaths?: Resolver<
    Array<ResolversTypes["PathType"]>,
    ParentType,
    ContextType
  >;
  searchPath?: Resolver<
    Array<Maybe<ResolversTypes["PathType"]>>,
    ParentType,
    ContextType,
    RequireFields<QuerySearchPathArgs, never>
  >;
};
